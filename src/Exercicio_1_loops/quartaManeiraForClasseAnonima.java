...
public class quartaManeiraForClasseAnonima {
    public static void main(String[] args) {
        ...
        // Aqui criamos uma classe anonima para implementar a interface consumer para não precisar criar uma classe aninhada

//        Consumer<Joagador> joagadorConsumer = new Consumer<Joagador>() {
//            @Override
//            public void accept(Joagador joagador) {
//                System.out.println(joagador);
//            }
//        };
//
//        jogadores.forEach(joagadorConsumer);

        // essa é uma maneira direta de se criar classe anonima passando ela dentro do forEach
